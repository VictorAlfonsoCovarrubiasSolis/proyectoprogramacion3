 ...
 * 
 */
public class ComprarComponentes extends javax.swing.JFrame {

    Connection con;
    String usuario;
    public ComprarComponentes(Connection c, String u) throws SQLException{//recibe la conexion a la base de datos
        con = c;
        usuario=u;
        this.setTitle("Seleccion de Componentes");
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Seleccion de componentes");
    ...
    public void rellenarcombo(){
        ...
        try{
            ...
            String tablaproductos= ("SELECT * FROM productos WHERE tipo='componente' || 'Componente'");
