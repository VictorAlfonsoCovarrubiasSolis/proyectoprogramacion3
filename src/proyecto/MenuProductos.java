...
public class MenuProductos extends javax.swing.JFrame {
    ...
    String usuario;
    Connection con;
    public MenuProductos(Connection c, String u)  throws SQLException {
        con = c;
        usuario=u;
        this.setTitle("Menu Compra");
    ...
    private void btnConsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConsActionPerformed
        try {
            new ComprarConsolas(con, usuario).setVisible(true);
    ...
    private void btnCompActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCompActionPerformed
        try {
            new ComprarComponentes(con, usuario).setVisible(true);
        }catch(SQLException e) {
            System.out.println("Error"+e);
        }
        this.dispose();
    ...
    private void btnVideActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVideActionPerformed
        try {
            new ComprarVideojuegos(con, usuario).setVisible(true);
        }catch(SQLException e) {
            System.out.println("Error"+e);
        }
        this.dispose();
    ...
    class Fondo extends javax.swing.JPanel{//funcion creada para que se cambie el fondo del panel
        ...
        public void paint(java.awt.Graphics g){//funcion que recibe graficos y sirve para cambiar fondos
            imagen = new javax.swing.ImageIcon(getClass().getResource("/imagenes/menucompras.jpeg")).getImage();
