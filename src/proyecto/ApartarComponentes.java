 ...
 * @author victor
 */
public class ApartarComponentes extends javax.swing.JFrame {

    Connection con;
    String usuario;
    public ApartarComponentes(Connection c, String u) throws SQLException{//recibe la conexion a la base de datos
        con = c;
        usuario=u;
