 ...
 * @author victor
 */
public class ApartarConsolas extends javax.swing.JFrame {

    Connection con;
    String usuario;
    public ApartarConsolas(Connection c, String u) throws SQLException{//recibe la conexion a la base de datos
        con = c;
        usuario=u;
