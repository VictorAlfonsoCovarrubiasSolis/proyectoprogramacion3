 ...
 * 
 */
public class ComprarConsolas extends javax.swing.JFrame {

    Connection con;
    String usuario;
    public ComprarConsolas(Connection c, String u) throws SQLException{//recibe la conexion a la base de datos
        con = c;
        usuario=u;
        this.setTitle("Seleccion de Consolas");
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Seleccion de consolas");
    ...
    public void rellenarcombo(){
        ...
        try{
            ...
            String tablaproductos= ("SELECT * FROM productos WHERE tipo='consola' || 'Consola'");
    ...
    public void actualizartabla(){
        ...
        try{
            ...
            s = con.createStatement();//se crea un statement sql
            String tablausers= ("SELECT * FROM productos WHERE tipo='consola' || 'Consola'");
        ...
        try{
            ...
            while(rs.next() && cont==0){
                if((rs.getString("nombre").equals(jComboBox1.getSelectedItem().toString()))){//si se encuentra lo seleccionado en la tabla de productos
                     new Confirmarcompra(con, usuario, rs.getString("nombre"), rs.getString("cantidad"), rs.getString("precio")).setVisible(true);
                     this.dispose();//se cierra la ventana de login al abrirse la de registro
                     cont++;
                }
            }
